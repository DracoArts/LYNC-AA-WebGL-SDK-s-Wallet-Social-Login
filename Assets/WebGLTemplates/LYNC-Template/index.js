...
function InitializeWeb3(Web3AuthClientId) {
  console.log("Initializing Web3Auth for Sepolia Testnet");
  ...
  lync.web3auth = new window.Web3Auth({
    ...
    // Add these configurations for social logins
    uiConfig: {
      theme: "light",
      loginMethodsOrder: ["google", "facebook", "twitter", "discord", "github", "apple", "line", "email_passwordless"],
      appLogo: "https://your-app-logo.png" // Add your app logo
    },
